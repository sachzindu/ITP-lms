    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-[url(/src/assets/blurimage.avif)] bg-cover bg-center h-64 w-full bg-gradient-to- bg-[#1e81b0] text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-black text-4xl font-bold mb-4">Welcome to IgniteLearn Support</h2>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { title: "Educational Issues", img: "/src/assets/image.png", desc: "Help with learning content" },
            { title: "Technical Issues", img: "/src/assets/technical.jpg", desc: "Solve platform problems" },
            { title: "Payment Issues", img: "/src/assets/payment.png", desc: "Billing support" },
          ].map((category) => (
            <div key={category.title} className="card bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-4">
                ...
                <Link to="/ticket/create" className="text-blue-600 font-medium hover:underline">
                  Create Ticket →
                </Link>
              </div>
            </div>
                ...
                <tbody className="divide-y divide-gray-200">
                  {search(books).map((book, index) => (
                    <tr key={book._id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-4 px-4 hidden md:table-cell">{book.email}</td>
                      <td className="py-4 px-4 hidden md:table-cell">{book.registrationNumber}</td>
