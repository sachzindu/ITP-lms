...
import { useCreateTicketMutation } from "../../redux/api/supportApiSlice";
...
const CreateTicket = () => {
  ...
  const handleSaveBook = async() => {
    ...
    setLoading(true);
    try{
    const output=await createTicket(data).unwrap();

    if(output){
      enqueueSnackbar("Your operation was successful!", {
  variant: "success",
});
        ...
        enqueueSnackbar("Error can't create ticket", {
        variant: "error",
      });
