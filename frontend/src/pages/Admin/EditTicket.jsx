...
import { useLazyGetTicketDetailsQuery, useUpdateTicketMutation } from '../../redux/api/supportApiSlice';
...
const EditTicket = () => {
  ...
  const [getTicketDetails]=useLazyGetTicketDetailsQuery();
  ...
  useEffect(() => {
    ...
    const getTicketsNow=async()=>{
       ...
       try{
         setLoading(true);
       const response=await getTicketDetails(id).unwrap();
  ...
  const handleEditBook = () => {
    ...
    const handleEditTicket=async ()=>{
      ...
      try{
        ...
        setLoading(true);
        const response=await updateTicket(data).unwrap();
        if(response){
