...
const Navigation = () => {
    ...
    return (
        <div id="navigation-container" className="w-screen h-[80px] z-10 bg-[#eeeee4] fixed top-0 left-0 flex justify-between items-center px-6 py-6 shadow-md">
         <div className="px-2 flex justify-between items-center w-full h-full">
            <div className="flex space-x-8">
              ...
              <ul className="flex space-x-6">
                ...
                <li className="px-4 py-4"><Link to="/shop" className="flex items-center space-x-2 text-black hover:text-gray-200">
                    <span>Classes</span>
                </Link ></li>
                <li className="px-4 py-4"><Link to="/cart" className="flex items-center space-x-2 text-black hover:text-gray-200">
                    <span>Cart</span>
                </Link></li>
                <li className="px-4 py-4"><Link to="/cart" className="flex items-center space-x-2 text-black hover:text-gray-200">
                    <span>Support</span>
