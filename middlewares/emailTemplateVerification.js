  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              ...
              <div class="otp-box">{resetOtp}</div>
...
export const Password_Reset_Success_Email_Template = `
  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              <p>Hello,</p>
              <p>This is to confirm that your password was successfully changed. If this wasn’t you, please contact our support team immediately to secure your account.</p>
          </div>
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} Your Company. All rights reserved.</p>
          </div>
